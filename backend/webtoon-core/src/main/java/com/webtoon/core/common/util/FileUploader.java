...
public class FileUploader {
    ...
    private String uniqueFileNameOf(MultipartFile file) {
    ...
    private String episodeContentsPathOf(String fileName) {
    ...
    private String episodeThumbnailPathOf(String fileName) {
        return new StringBuilder().append(BASE_FILE_PATH)
    ...
    private String webtoonThumbnailPathOf(String fileName) {
        return new StringBuilder().append(BASE_FILE_PATH)
    ...
    public String uploadEpisodeThumbnail(MultipartFile file) throws IOException {
    ...
    public String uploadWebtoonThumbnail(MultipartFile file) throws IOException {
        String thumbnail = uniqueFileNameOf(file);
    ...
    public String uploadContentImages(MultipartFile[] files) throws IOException {
