  ...
  React.useEffect(() => {
    ...
    fetch(
      ...
      .then((result) => {
        ...
        else setRating_avg(result.data.rating_avg);
          ...
          <div style={{ marginLeft: 30 }}>
            ...
            >
              ...
              <body2 style={{ marginTop: 30 }}>
                &nbsp;{rating_avg} (참여자수 {rating_prt})&ensp;
              </body2>

              <FormControl className={classes.formControl}>
                <InputLabel htmlFor="star-score">별점</InputLabel>
                <Select native value={score} onChange={handleScoreChange}>
          ...
          <div className={classes.comment}>
            ...
            <div style={{ display: "flex" }}>
              ...
              <Button
                ...
                style={{ height: 40, marginLeft: 10, marginTop: 70 }}
              >
                등록
              </Button>
            </div>
