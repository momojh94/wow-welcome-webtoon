    ...
    <div>
      <Switch>
        ...
        <AuthRoute
          ...
          render={(props) => <EditInfo {...props} />}
        />
        <AuthRoute
          path="/mypage/editRegister"
          render={(props) => <EditRegister {...props} />}
        />
        <AuthRoute
          path="/mypage/editEpisode"
          render={(props) => <EditEpisode {...props} />}
        />
        <AuthRoute
