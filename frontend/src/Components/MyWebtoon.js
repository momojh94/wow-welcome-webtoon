                        ...
                        <CardActionArea>
                            <CardContent>
                                ...
                                <div style={{ display: "flex", margin:3}}>
                                    <Button variant="contained" href={"/mypage/editRegister?webtoon_idx=" + this.props.idx} style={{marginRight:10}}>작품 정보 수정</Button>
                                    <Button variant="contained" href={"/mypage/editEpisode?webtoon_idx=" + this.props.idx}>회차 관리</Button>
                                </div>
                            </CardContent>
                        </CardActionArea>
                    </Card>
